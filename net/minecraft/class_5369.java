...
public class class_5369<T extends ResourcePackProfile> {
    ...
    public Stream<class_5371> method_29639() {
        return this.field_25456.stream().map(arg -> new class_5374(this, arg));
    }

    public Stream<class_5371> method_29643() {
        return this.field_25455.stream().map(arg -> new class_5373(this, arg));
    }

    public void method_29642(boolean bl) {
        this.field_25459.accept((List<T>)ImmutableList.copyOf(this.field_25455), (List<T>)ImmutableList.copyOf(this.field_25456), bl);
    }
    ...
    extends class_5372 {
        ...
        public class_5374(T arg2) {
            this.field_25463 = arg;
            super((class_5369)arg, arg2);
        }
    ...
    implements class_5371 {
        ...
        public class_5372(T arg2) {
            this.field_25460 = arg;
            this.field_25461 = arg2;
        }
        ...
        @Override
        public void method_29649(TextureManager arg) {
            this.field_25460.field_25457.accept(this.field_25461, arg);
        }
