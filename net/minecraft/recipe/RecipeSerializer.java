...
public interface RecipeSerializer<T extends Recipe<?>> {
    ...
    public static <S extends RecipeSerializer<T>, T extends Recipe<?>> S register(String string, S arg) {
        return (S)Registry.register(Registry.RECIPE_SERIALIZER, string, arg);
    }
}
