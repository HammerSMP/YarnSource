...
public class TradeOffers {
    ...
    implements Factory {
        ...
        public SellMapFactory(int i, String string, MapIcon.Type arg, int j, int k) {
            this.price = i;
        ...
        public TradeOffer create(Entity arg, Random random) {
            ...
            if (lv2 != null) {
                ...
                lv3.setCustomName(new TranslatableText("filled_map." + this.structure.toLowerCase(Locale.ROOT)));
