...
public class VillagerData {
    ...
    public static final Codec<VillagerData> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Registry.VILLAGER_TYPE.fieldOf("type").forGetter(arg -> arg.type), (App)Registry.VILLAGER_PROFESSION.fieldOf("profession").forGetter(arg -> arg.profession), (App)Codec.INT.fieldOf("level").withDefault((Object)1).forGetter(arg -> arg.level)).apply((Applicative)instance, VillagerData::new));
