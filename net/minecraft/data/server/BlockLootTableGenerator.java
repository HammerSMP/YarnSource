...
implements Consumer<BiConsumer<Identifier, LootTable.Builder>> {
    ...
    private static LootTable.Builder drops(Block arg, LootCondition.Builder arg2, LootPoolEntry.Builder<?> arg3) {
    ...
    private static LootTable.Builder dropsWithSilkTouch(Block arg, LootPoolEntry.Builder<?> arg2) {
        return BlockLootTableGenerator.drops(arg, WITH_SILK_TOUCH, arg2);
    }

    private static LootTable.Builder dropsWithShears(Block arg, LootPoolEntry.Builder<?> arg2) {
        return BlockLootTableGenerator.drops(arg, WITH_SHEARS, arg2);
    }

    private static LootTable.Builder dropsWithSilkTouchOrShears(Block arg, LootPoolEntry.Builder<?> arg2) {
    ...
    private static LootTable.Builder drops(Block arg, ItemConvertible arg2) {
        return BlockLootTableGenerator.dropsWithSilkTouch(arg, (LootPoolEntry.Builder)BlockLootTableGenerator.addSurvivesExplosionCondition(arg, ItemEntry.builder(arg2)));
    }

    private static LootTable.Builder drops(ItemConvertible arg, LootTableRange arg2) {
        return LootTable.builder().pool(LootPool.builder().rolls(ConstantLootTableRange.create(1)).with((LootPoolEntry.Builder)BlockLootTableGenerator.applyExplosionDecay(arg, ItemEntry.builder(arg).apply(SetCountLootFunction.builder(arg2)))));
    }

    private static LootTable.Builder drops(Block arg, ItemConvertible arg2, LootTableRange arg3) {
        return BlockLootTableGenerator.dropsWithSilkTouch(arg, (LootPoolEntry.Builder)BlockLootTableGenerator.applyExplosionDecay(arg, ItemEntry.builder(arg2).apply(SetCountLootFunction.builder(arg3))));
    }
    ...
    private static <T extends Comparable<T> & StringIdentifiable> LootTable.Builder dropsWithProperty(Block arg, Property<T> arg2, T comparable) {
        return LootTable.builder().pool(BlockLootTableGenerator.addSurvivesExplosionCondition(arg, LootPool.builder().rolls(ConstantLootTableRange.create(1)).with((LootPoolEntry.Builder<?>)ItemEntry.builder(arg).conditionally(BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(arg2, comparable))))));
    }

    private static LootTable.Builder nameableContainerDrops(Block arg) {
        return LootTable.builder().pool(BlockLootTableGenerator.addSurvivesExplosionCondition(arg, LootPool.builder().rolls(ConstantLootTableRange.create(1)).with((LootPoolEntry.Builder<?>)ItemEntry.builder(arg).apply(CopyNameLootFunction.builder(CopyNameLootFunction.Source.BLOCK_ENTITY)))));
    }
    ...
    private static LootTable.Builder oreDrops(Block arg, Item arg2) {
        return BlockLootTableGenerator.dropsWithSilkTouch(arg, (LootPoolEntry.Builder)BlockLootTableGenerator.applyExplosionDecay(arg, ItemEntry.builder(arg2).apply(ApplyBonusLootFunction.oreDrops(Enchantments.FORTUNE))));
    }

    private static LootTable.Builder mushroomBlockDrops(Block arg, ItemConvertible arg2) {
        return BlockLootTableGenerator.dropsWithSilkTouch(arg, (LootPoolEntry.Builder)BlockLootTableGenerator.applyExplosionDecay(arg, ((LeafEntry.Builder)ItemEntry.builder(arg2).apply(SetCountLootFunction.builder(UniformLootTableRange.between(-6.0f, 2.0f)))).apply(LimitCountLootFunction.builder(BoundedIntUnaryOperator.createMin(0)))));
    }

    private static LootTable.Builder grassDrops(Block arg) {
        return BlockLootTableGenerator.dropsWithShears(arg, (LootPoolEntry.Builder)BlockLootTableGenerator.applyExplosionDecay(arg, ((LeafEntry.Builder)ItemEntry.builder(Items.WHEAT_SEEDS).conditionally(RandomChanceLootCondition.builder(0.125f))).apply(ApplyBonusLootFunction.uniformBonusCount(Enchantments.FORTUNE, 2))));
    }
    ...
    private static LootTable.Builder attachedCropStemDrops(Block arg, Item arg2) {
        return LootTable.builder().pool(BlockLootTableGenerator.applyExplosionDecay(arg, LootPool.builder().rolls(ConstantLootTableRange.create(1)).with((LootPoolEntry.Builder<?>)ItemEntry.builder(arg2).apply(SetCountLootFunction.builder(BinomialLootTableRange.create(3, 0.53333336f))))));
    }
    ...
    private static LootTable.Builder cropDrops(Block arg, Item arg2, Item arg3, LootCondition.Builder arg4) {
        return BlockLootTableGenerator.applyExplosionDecay(arg, LootTable.builder().pool(LootPool.builder().with(((LeafEntry.Builder)ItemEntry.builder(arg2).conditionally(arg4)).alternatively(ItemEntry.builder(arg3)))).pool(LootPool.builder().conditionally(arg4).with((LootPoolEntry.Builder<?>)ItemEntry.builder(arg3).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286f, 3)))));
    }

    private static LootTable.Builder method_30159(Block arg) {
        return LootTable.builder().pool(LootPool.builder().conditionally(WITH_SHEARS).with((LootPoolEntry.Builder<?>)ItemEntry.builder(arg).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))));
    }

    private static LootTable.Builder method_30158(Block arg, Block arg2) {
        AlternativeEntry.Builder lv = ((LeafEntry.Builder)((LootPoolEntry.Builder)ItemEntry.builder(arg2).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2)))).conditionally(WITH_SHEARS)).alternatively((LootPoolEntry.Builder<?>)((LeafEntry.Builder)BlockLootTableGenerator.addSurvivesExplosionCondition(arg, ItemEntry.builder(Items.WHEAT_SEEDS))).conditionally(RandomChanceLootCondition.builder(0.125f)));
        return LootTable.builder().pool(LootPool.builder().with(lv).conditionally(BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, DoubleBlockHalf.LOWER))).conditionally(LocationCheckLootCondition.method_30151(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().block(arg).state(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, DoubleBlockHalf.UPPER).build()).build()), new BlockPos(0, 1, 0)))).pool(LootPool.builder().with(lv).conditionally(BlockStatePropertyLootCondition.builder(arg).properties(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, DoubleBlockHalf.UPPER))).conditionally(LocationCheckLootCondition.method_30151(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().block(arg).state(StatePredicate.Builder.create().exactMatch(TallPlantBlock.HALF, DoubleBlockHalf.LOWER).build()).build()), new BlockPos(0, -1, 0))));
    }
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
        ...
        this.addDrop(Blocks.CARROTS, BlockLootTableGenerator.applyExplosionDecay(Blocks.CARROTS, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.CARROT))).pool(LootPool.builder().conditionally(lv3).with((LootPoolEntry.Builder<?>)ItemEntry.builder(Items.CARROT).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286f, 3))))));
        ...
        this.addDrop(Blocks.POTATOES, BlockLootTableGenerator.applyExplosionDecay(Blocks.POTATOES, LootTable.builder().pool(LootPool.builder().with(ItemEntry.builder(Items.POTATO))).pool(LootPool.builder().conditionally(lv4).with((LootPoolEntry.Builder<?>)ItemEntry.builder(Items.POTATO).apply(ApplyBonusLootFunction.binomialWithBonusCount(Enchantments.FORTUNE, 0.5714286f, 3)))).pool(LootPool.builder().conditionally(lv4).with((LootPoolEntry.Builder<?>)ItemEntry.builder(Items.POISONOUS_POTATO).conditionally(RandomChanceLootCondition.builder(0.02f))))));
        ...
        this.addDrop(Blocks.COBWEB, (Block arg) -> BlockLootTableGenerator.dropsWithSilkTouchOrShears(arg, (LootPoolEntry.Builder)BlockLootTableGenerator.addSurvivesExplosionCondition(arg, ItemEntry.builder(Items.STRING))));
        this.addDrop(Blocks.DEAD_BUSH, (Block arg) -> BlockLootTableGenerator.dropsWithShears(arg, (LootPoolEntry.Builder)BlockLootTableGenerator.applyExplosionDecay(arg, ItemEntry.builder(Items.STICK).apply(SetCountLootFunction.builder(UniformLootTableRange.between(0.0f, 2.0f))))));
        ...
        this.addDrop(Blocks.LARGE_FERN, (Block arg) -> BlockLootTableGenerator.method_30158(arg, Blocks.FERN));
        this.addDrop(Blocks.TALL_GRASS, (Block arg) -> BlockLootTableGenerator.method_30158(arg, Blocks.GRASS));
        ...
        this.addDrop(Blocks.CAMPFIRE, (Block arg) -> BlockLootTableGenerator.dropsWithSilkTouch(arg, (LootPoolEntry.Builder)BlockLootTableGenerator.addSurvivesExplosionCondition(arg, ItemEntry.builder(Items.CHARCOAL).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(2))))));
        this.addDrop(Blocks.GILDED_BLACKSTONE, (Block arg) -> BlockLootTableGenerator.dropsWithSilkTouch(arg, BlockLootTableGenerator.addSurvivesExplosionCondition(arg, ((LeafEntry.Builder)((LootPoolEntry.Builder)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootTableRange.between(2.0f, 5.0f)))).conditionally(TableBonusLootCondition.builder(Enchantments.FORTUNE, 0.1f, 0.14285715f, 0.25f, 1.0f))).alternatively(ItemEntry.builder(arg)))));
        this.addDrop(Blocks.SOUL_CAMPFIRE, (Block arg) -> BlockLootTableGenerator.dropsWithSilkTouch(arg, (LootPoolEntry.Builder)BlockLootTableGenerator.addSurvivesExplosionCondition(arg, ItemEntry.builder(Items.SOUL_SOIL).apply(SetCountLootFunction.builder(ConstantLootTableRange.create(1))))));
