...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement lv13 = Advancement.Task.create().parent(lv).display(Items.POLISHED_BLACKSTONE_BRICKS, (Text)new TranslatableText("advancements.nether.find_bastion.title"), (Text)new TranslatableText("advancements.nether.find_bastion.description"), null, AdvancementFrame.TASK, true, true, false).criterion("bastion", LocationArrivalCriterion.Conditions.create(LocationPredicate.feature(Feature.BASTION_REMNANT))).build(consumer, "nether/find_bastion");
