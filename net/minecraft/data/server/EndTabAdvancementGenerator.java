...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement lv7 = Advancement.Task.create().parent(lv5).display(Items.SHULKER_SHELL, (Text)new TranslatableText("advancements.end.levitate.title"), (Text)new TranslatableText("advancements.end.levitate.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).criterion("levitated", LevitationCriterion.Conditions.create(DistancePredicate.y(NumberRange.FloatRange.atLeast(50.0f)))).build(consumer, "end/levitate");
        Advancement lv8 = Advancement.Task.create().parent(lv5).display(Items.ELYTRA, (Text)new TranslatableText("advancements.end.elytra.title"), (Text)new TranslatableText("advancements.end.elytra.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("elytra", InventoryChangedCriterion.Conditions.items(Items.ELYTRA)).build(consumer, "end/elytra");
