...
implements Consumer<Consumer<Advancement>> {
    ...
    public void accept(Consumer<Advancement> consumer) {
        ...
        Advancement lv10 = Advancement.Task.create().parent(lv9).display(Items.FLINT_AND_STEEL, (Text)new TranslatableText("advancements.story.enter_the_nether.title"), (Text)new TranslatableText("advancements.story.enter_the_nether.description"), null, AdvancementFrame.TASK, true, true, false).criterion("entered_nether", ChangedDimensionCriterion.Conditions.to(DimensionType.THE_NETHER)).build(consumer, "story/enter_the_nether");
        ...
        Advancement lv11 = Advancement.Task.create().parent(lv10).display(Items.ENDER_EYE, (Text)new TranslatableText("advancements.story.follow_ender_eye.title"), (Text)new TranslatableText("advancements.story.follow_ender_eye.description"), null, AdvancementFrame.TASK, true, true, false).criterion("in_stronghold", LocationArrivalCriterion.Conditions.create(LocationPredicate.feature(Feature.STRONGHOLD))).build(consumer, "story/follow_ender_eye");
