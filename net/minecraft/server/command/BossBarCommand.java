...
public class BossBarCommand {
    ...
    private static final SimpleCommandExceptionType SETMAX_UNCHANGED_EXCEPTION = new SimpleCommandExceptionType((Message)new TranslatableText("commands.bossbar.set.max.unchanged"));
