...
public class FillCommand {
    ...
    private static int execute(ServerCommandSource arg, BlockBox arg2, BlockStateArgument arg3, Mode arg4, @Nullable Predicate<CachedBlockPosition> predicate) throws CommandSyntaxException {
        int i = arg2.getBlockCountX() * arg2.getBlockCountY() * arg2.getBlockCountZ();
        if (i > 32768) {
        ...
        int j = 0;
        for (BlockPos lv2 : BlockPos.iterate(arg2.minX, arg2.minY, arg2.minZ, arg2.maxX, arg2.maxY, arg2.maxZ)) {
            BlockStateArgument lv3;
            if (predicate != null && !predicate.test(new CachedBlockPosition(lv, lv2, true)) || (lv3 = arg4.filter.filter(arg2, lv2, arg3, lv)) == null) continue;
        ...
        arg.sendFeedback(new TranslatableText("commands.fill.success", j), true);
        return j;
    }
