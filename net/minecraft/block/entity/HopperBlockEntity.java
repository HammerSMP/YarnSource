...
Tickable {
    ...
    public static List<ItemEntity> getInputItemEntities(Hopper arg) {
        return arg.getInputAreaShape().getBoundingBoxes().stream().flatMap(arg2 -> arg.getWorld().getEntitiesByClass(ItemEntity.class, arg2.offset(arg.getHopperX() - 0.5, arg.getHopperY() - 0.5, arg.getHopperZ() - 0.5), EntityPredicates.VALID_ENTITY).stream()).collect(Collectors.toList());
    }
