...
public class Blocks {
    ...
    public static final Block NETHER_PORTAL = Blocks.register("nether_portal", new NetherPortalBlock(AbstractBlock.Settings.of(Material.PORTAL).noCollision().ticksRandomly().strength(-1.0f).sounds(BlockSoundGroup.GLASS).lightLevel(arg -> 11)));
    ...
    public static final Block IRON_BARS = Blocks.register("iron_bars", new PaneBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.AIR).requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    public static final Block CHAIN = Blocks.register("chain", new ChainBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.AIR).requiresTool().strength(5.0f, 6.0f).sounds(BlockSoundGroup.CHAIN).nonOpaque()));
    ...
    public static final Block BREWING_STAND = Blocks.register("brewing_stand", new BrewingStandBlock(AbstractBlock.Settings.of(Material.METAL).requiresTool().strength(0.5f).lightLevel(arg -> 1).nonOpaque()));
    ...
    public static final Block ENDER_CHEST = Blocks.register("ender_chest", new EnderChestBlock(AbstractBlock.Settings.of(Material.STONE).requiresTool().strength(22.5f, 600.0f).lightLevel(arg -> 7)));
    ...
    public static final Block IRON_TRAPDOOR = Blocks.register("iron_trapdoor", new TrapdoorBlock(AbstractBlock.Settings.of(Material.METAL).requiresTool().strength(5.0f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    ...
    public static final Block MAGMA_BLOCK = Blocks.register("magma_block", new MagmaBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).requiresTool().lightLevel(arg -> 3).ticksRandomly().strength(0.5f).allowsSpawning((arg, arg2, arg3, arg4) -> arg4.isFireImmune()).postProcess(Blocks::always).emissiveLighting(Blocks::always)));
    ...
    public static final Block LANTERN = Blocks.register("lantern", new LanternBlock(AbstractBlock.Settings.of(Material.METAL).requiresTool().strength(3.5f).sounds(BlockSoundGroup.LANTERN).lightLevel(arg -> 15).nonOpaque()));
    public static final Block SOUL_LANTERN = Blocks.register("soul_lantern", new LanternBlock(AbstractBlock.Settings.of(Material.METAL).requiresTool().strength(3.5f).sounds(BlockSoundGroup.LANTERN).lightLevel(arg -> 10).nonOpaque()));
    ...
    public static final Block WARPED_NYLIUM = Blocks.register("warped_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.CYAN).requiresTool().strength(0.4f).sounds(BlockSoundGroup.NYLIUM).ticksRandomly()));
    ...
    public static final Block CRIMSON_NYLIUM = Blocks.register("crimson_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).requiresTool().strength(0.4f).sounds(BlockSoundGroup.NYLIUM).ticksRandomly()));
    ...
    public static final Block CRYING_OBSIDIAN = Blocks.register("crying_obsidian", new CryingObsidianBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().strength(50.0f, 1200.0f).lightLevel(arg -> 10)));
    public static final Block RESPAWN_ANCHOR = Blocks.register("respawn_anchor", new RespawnAnchorBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).requiresTool().strength(50.0f, 1200.0f).lightLevel(arg -> RespawnAnchorBlock.getLightLevel(arg, 15))));
