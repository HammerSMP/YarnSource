...
public class Blocks {
    ...
    public static final Block RESPAWN_ANCHOR = Blocks.register("respawn_anchor", new RespawnAnchorBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).method_29292().strength(50.0f, 1200.0f).lightLevel(arg -> RespawnAnchorBlock.getLightLevel(arg, 15))));
