...
public class Blocks {
    ...
    public static final Block STONE = Blocks.register("stone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).method_29292().strength(1.5f, 6.0f)));
    public static final Block GRANITE = Blocks.register("granite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIRT).method_29292().strength(1.5f, 6.0f)));
    public static final Block POLISHED_GRANITE = Blocks.register("polished_granite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIRT).method_29292().strength(1.5f, 6.0f)));
    public static final Block DIORITE = Blocks.register("diorite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).method_29292().strength(1.5f, 6.0f)));
    public static final Block POLISHED_DIORITE = Blocks.register("polished_diorite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).method_29292().strength(1.5f, 6.0f)));
    public static final Block ANDESITE = Blocks.register("andesite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).method_29292().strength(1.5f, 6.0f)));
    public static final Block POLISHED_ANDESITE = Blocks.register("polished_andesite", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).method_29292().strength(1.5f, 6.0f)));
    ...
    public static final Block COBBLESTONE = Blocks.register("cobblestone", new Block(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(2.0f, 6.0f)));
    ...
    public static final Block LAPIS_ORE = Blocks.register("lapis_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(3.0f, 3.0f)));
    public static final Block LAPIS_BLOCK = Blocks.register("lapis_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.LAPIS).method_29292().strength(3.0f, 3.0f)));
    public static final Block DISPENSER = Blocks.register("dispenser", new DispenserBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(3.5f)));
    public static final Block SANDSTONE = Blocks.register("sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).method_29292().strength(0.8f)));
    public static final Block CHISELED_SANDSTONE = Blocks.register("chiseled_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).method_29292().strength(0.8f)));
    public static final Block CUT_SANDSTONE = Blocks.register("cut_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).method_29292().strength(0.8f)));
    ...
    public static final Block COBWEB = Blocks.register("cobweb", new CobwebBlock(AbstractBlock.Settings.of(Material.COBWEB).noCollision().method_29292().strength(4.0f)));
    ...
    public static final Block GOLD_BLOCK = Blocks.register("gold_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.GOLD).method_29292().strength(3.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    public static final Block IRON_BLOCK = Blocks.register("iron_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.IRON).method_29292().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    public static final Block BRICKS = Blocks.register("bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).method_29292().strength(2.0f, 6.0f)));
    ...
    public static final Block MOSSY_COBBLESTONE = Blocks.register("mossy_cobblestone", new Block(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(2.0f, 6.0f)));
    public static final Block OBSIDIAN = Blocks.register("obsidian", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).method_29292().strength(50.0f, 1200.0f)));
    public static final Block TORCH = Blocks.register("torch", new TorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(arg -> 14).sounds(BlockSoundGroup.WOOD), ParticleTypes.FLAME));
    public static final Block WALL_TORCH = Blocks.register("wall_torch", new WallTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(arg -> 14).sounds(BlockSoundGroup.WOOD).dropsLike(TORCH), ParticleTypes.FLAME));
    ...
    public static final Block SPAWNER = Blocks.register("spawner", new SpawnerBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(5.0f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    ...
    public static final Block DIAMOND_ORE = Blocks.register("diamond_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(3.0f, 3.0f)));
    public static final Block DIAMOND_BLOCK = Blocks.register("diamond_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.DIAMOND).method_29292().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block FARMLAND = Blocks.register("farmland", new FarmlandBlock(AbstractBlock.Settings.of(Material.SOIL).ticksRandomly().strength(0.6f).sounds(BlockSoundGroup.GRAVEL).blockVision(Blocks::always)));
    public static final Block FURNACE = Blocks.register("furnace", new FurnaceBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(3.5f).lightLevel(Blocks.createLightLevelFromBlockState(13))));
    ...
    public static final Block STONE_PRESSURE_PLATE = Blocks.register("stone_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.MOBS, AbstractBlock.Settings.of(Material.STONE).method_29292().noCollision().strength(0.5f)));
    public static final Block IRON_DOOR = Blocks.register("iron_door", new DoorBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.IRON).method_29292().strength(5.0f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    ...
    public static final Block REDSTONE_ORE = Blocks.register("redstone_ore", new RedstoneOreBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().ticksRandomly().lightLevel(Blocks.createLightLevelFromBlockState(9)).strength(3.0f, 3.0f)));
    public static final Block REDSTONE_TORCH = Blocks.register("redstone_torch", new RedstoneTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(Blocks.createLightLevelFromBlockState(7)).sounds(BlockSoundGroup.WOOD)));
    public static final Block REDSTONE_WALL_TORCH = Blocks.register("redstone_wall_torch", new WallRedstoneTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(Blocks.createLightLevelFromBlockState(7)).sounds(BlockSoundGroup.WOOD).dropsLike(REDSTONE_TORCH)));
    ...
    public static final Block SNOW = Blocks.register("snow", new SnowBlock(AbstractBlock.Settings.of(Material.SNOW_LAYER).ticksRandomly().strength(0.1f).method_29292().sounds(BlockSoundGroup.SNOW)));
    ...
    public static final Block SNOW_BLOCK = Blocks.register("snow_block", new Block(AbstractBlock.Settings.of(Material.SNOW_BLOCK).method_29292().strength(0.2f).sounds(BlockSoundGroup.SNOW)));
    ...
    public static final Block NETHERRACK = Blocks.register("netherrack", new NetherrackBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().strength(0.4f).sounds(BlockSoundGroup.NETHERRACK)));
    public static final Block SOUL_SAND = Blocks.register("soul_sand", new SoulSandBlock(AbstractBlock.Settings.of(Material.AGGREGATE, MaterialColor.BROWN).strength(0.5f).velocityMultiplier(0.4f).sounds(BlockSoundGroup.SOUL_SAND).allowsSpawning(Blocks::always).solidBlock(Blocks::always).blockVision(Blocks::always)));
    ...
    public static final Block BASALT = Blocks.register("basalt", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).method_29292().strength(1.25f, 4.2f).sounds(BlockSoundGroup.BASALT)));
    public static final Block POLISHED_BASALT = Blocks.register("polished_basalt", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).method_29292().strength(1.25f, 4.2f).sounds(BlockSoundGroup.BASALT)));
    public static final Block SOUL_TORCH = Blocks.register("soul_torch", new TorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(arg -> 10).sounds(BlockSoundGroup.WOOD), ParticleTypes.SOUL_FIRE_FLAME));
    public static final Block SOUL_WALL_TORCH = Blocks.register("soul_wall_torch", new WallTorchBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().breakInstantly().lightLevel(arg -> 10).sounds(BlockSoundGroup.WOOD).dropsLike(SOUL_TORCH), ParticleTypes.SOUL_FIRE_FLAME));
    ...
    public static final Block JACK_O_LANTERN = Blocks.register("jack_o_lantern", new CarvedPumpkinBlock(AbstractBlock.Settings.of(Material.GOURD, MaterialColor.ORANGE).strength(1.0f).sounds(BlockSoundGroup.WOOD).lightLevel(arg -> 15).allowsSpawning(Blocks::always)));
    ...
    public static final Block STONE_BRICKS = Blocks.register("stone_bricks", new Block(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(1.5f, 6.0f)));
    public static final Block MOSSY_STONE_BRICKS = Blocks.register("mossy_stone_bricks", new Block(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(1.5f, 6.0f)));
    public static final Block CRACKED_STONE_BRICKS = Blocks.register("cracked_stone_bricks", new Block(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(1.5f, 6.0f)));
    public static final Block CHISELED_STONE_BRICKS = Blocks.register("chiseled_stone_bricks", new Block(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(1.5f, 6.0f)));
    ...
    public static final Block IRON_BARS = Blocks.register("iron_bars", new PaneBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.AIR).method_29292().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    public static final Block CHAIN = Blocks.register("chain", new ChainBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.AIR).method_29292().strength(5.0f, 6.0f).sounds(BlockSoundGroup.CHAIN).nonOpaque()));
    ...
    public static final Block LILY_PAD = Blocks.register("lily_pad", new LilyPadBlock(AbstractBlock.Settings.of(Material.PLANT).breakInstantly().sounds(BlockSoundGroup.field_25183).nonOpaque()));
    public static final Block NETHER_BRICKS = Blocks.register("nether_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    public static final Block NETHER_BRICK_FENCE = Blocks.register("nether_brick_fence", new FenceBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    ...
    public static final Block ENCHANTING_TABLE = Blocks.register("enchanting_table", new EnchantingTableBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).method_29292().strength(5.0f, 1200.0f)));
    public static final Block BREWING_STAND = Blocks.register("brewing_stand", new BrewingStandBlock(AbstractBlock.Settings.of(Material.METAL).method_29292().strength(0.5f).lightLevel(arg -> 1).nonOpaque()));
    public static final Block CAULDRON = Blocks.register("cauldron", new CauldronBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.STONE).method_29292().strength(2.0f).nonOpaque()));
    ...
    public static final Block END_STONE = Blocks.register("end_stone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).method_29292().strength(3.0f, 9.0f)));
    ...
    public static final Block EMERALD_ORE = Blocks.register("emerald_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(3.0f, 3.0f)));
    public static final Block ENDER_CHEST = Blocks.register("ender_chest", new EnderChestBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(22.5f, 600.0f).lightLevel(arg -> 7)));
    ...
    public static final Block EMERALD_BLOCK = Blocks.register("emerald_block", new Block(AbstractBlock.Settings.of(Material.METAL, MaterialColor.EMERALD).method_29292().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block COMMAND_BLOCK = Blocks.register("command_block", new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.BROWN).method_29292().strength(-1.0f, 3600000.0f).dropsNothing()));
    ...
    public static final Block OAK_BUTTON = Blocks.register("oak_button", new WoodButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block SPRUCE_BUTTON = Blocks.register("spruce_button", new WoodButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block BIRCH_BUTTON = Blocks.register("birch_button", new WoodButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block JUNGLE_BUTTON = Blocks.register("jungle_button", new WoodButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block ACACIA_BUTTON = Blocks.register("acacia_button", new WoodButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block DARK_OAK_BUTTON = Blocks.register("dark_oak_button", new WoodButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block ANVIL = Blocks.register("anvil", new AnvilBlock(AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).method_29292().strength(5.0f, 1200.0f).sounds(BlockSoundGroup.ANVIL)));
    public static final Block CHIPPED_ANVIL = Blocks.register("chipped_anvil", new AnvilBlock(AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).method_29292().strength(5.0f, 1200.0f).sounds(BlockSoundGroup.ANVIL)));
    public static final Block DAMAGED_ANVIL = Blocks.register("damaged_anvil", new AnvilBlock(AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).method_29292().strength(5.0f, 1200.0f).sounds(BlockSoundGroup.ANVIL)));
    ...
    public static final Block LIGHT_WEIGHTED_PRESSURE_PLATE = Blocks.register("light_weighted_pressure_plate", new WeightedPressurePlateBlock(15, AbstractBlock.Settings.of(Material.METAL, MaterialColor.GOLD).method_29292().noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block HEAVY_WEIGHTED_PRESSURE_PLATE = Blocks.register("heavy_weighted_pressure_plate", new WeightedPressurePlateBlock(150, AbstractBlock.Settings.of(Material.METAL).method_29292().noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block REDSTONE_BLOCK = Blocks.register("redstone_block", new RedstoneBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.LAVA).method_29292().strength(5.0f, 6.0f).sounds(BlockSoundGroup.METAL).solidBlock(Blocks::never)));
    public static final Block NETHER_QUARTZ_ORE = Blocks.register("nether_quartz_ore", new OreBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().strength(3.0f, 3.0f).sounds(BlockSoundGroup.NETHER_ORE)));
    public static final Block HOPPER = Blocks.register("hopper", new HopperBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.STONE).method_29292().strength(3.0f, 4.8f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    public static final Block QUARTZ_BLOCK = Blocks.register("quartz_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).method_29292().strength(0.8f)));
    public static final Block CHISELED_QUARTZ_BLOCK = Blocks.register("chiseled_quartz_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).method_29292().strength(0.8f)));
    public static final Block QUARTZ_PILLAR = Blocks.register("quartz_pillar", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).method_29292().strength(0.8f)));
    ...
    public static final Block DROPPER = Blocks.register("dropper", new DropperBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(3.5f)));
    public static final Block WHITE_TERRACOTTA = Blocks.register("white_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.WHITE_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block ORANGE_TERRACOTTA = Blocks.register("orange_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block MAGENTA_TERRACOTTA = Blocks.register("magenta_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.MAGENTA_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block LIGHT_BLUE_TERRACOTTA = Blocks.register("light_blue_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.LIGHT_BLUE_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block YELLOW_TERRACOTTA = Blocks.register("yellow_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.YELLOW_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block LIME_TERRACOTTA = Blocks.register("lime_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.LIME_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block PINK_TERRACOTTA = Blocks.register("pink_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.PINK_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block GRAY_TERRACOTTA = Blocks.register("gray_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block LIGHT_GRAY_TERRACOTTA = Blocks.register("light_gray_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.LIGHT_GRAY_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block CYAN_TERRACOTTA = Blocks.register("cyan_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.CYAN_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block PURPLE_TERRACOTTA = Blocks.register("purple_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.PURPLE_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block BLUE_TERRACOTTA = Blocks.register("blue_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLUE_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block BROWN_TERRACOTTA = Blocks.register("brown_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BROWN_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block GREEN_TERRACOTTA = Blocks.register("green_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GREEN_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block RED_TERRACOTTA = Blocks.register("red_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    public static final Block BLACK_TERRACOTTA = Blocks.register("black_terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK_TERRACOTTA).method_29292().strength(1.25f, 4.2f)));
    ...
    public static final Block IRON_TRAPDOOR = Blocks.register("iron_trapdoor", new TrapdoorBlock(AbstractBlock.Settings.of(Material.METAL).method_29292().strength(5.0f).sounds(BlockSoundGroup.METAL).nonOpaque()));
    public static final Block PRISMARINE = Blocks.register("prismarine", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.CYAN).method_29292().strength(1.5f, 6.0f)));
    public static final Block PRISMARINE_BRICKS = Blocks.register("prismarine_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIAMOND).method_29292().strength(1.5f, 6.0f)));
    public static final Block DARK_PRISMARINE = Blocks.register("dark_prismarine", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIAMOND).method_29292().strength(1.5f, 6.0f)));
    ...
    public static final Block PRISMARINE_SLAB = Blocks.register("prismarine_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.CYAN).method_29292().strength(1.5f, 6.0f)));
    public static final Block PRISMARINE_BRICK_SLAB = Blocks.register("prismarine_brick_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIAMOND).method_29292().strength(1.5f, 6.0f)));
    public static final Block DARK_PRISMARINE_SLAB = Blocks.register("dark_prismarine_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.DIAMOND).method_29292().strength(1.5f, 6.0f)));
    ...
    public static final Block TERRACOTTA = Blocks.register("terracotta", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).method_29292().strength(1.25f, 4.2f)));
    public static final Block COAL_BLOCK = Blocks.register("coal_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).method_29292().strength(5.0f, 6.0f)));
    ...
    public static final Block RED_SANDSTONE = Blocks.register("red_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).method_29292().strength(0.8f)));
    public static final Block CHISELED_RED_SANDSTONE = Blocks.register("chiseled_red_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).method_29292().strength(0.8f)));
    public static final Block CUT_RED_SANDSTONE = Blocks.register("cut_red_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).method_29292().strength(0.8f)));
    ...
    public static final Block STONE_SLAB = Blocks.register("stone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).method_29292().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_STONE_SLAB = Blocks.register("smooth_stone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).method_29292().strength(2.0f, 6.0f)));
    public static final Block SANDSTONE_SLAB = Blocks.register("sandstone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).method_29292().strength(2.0f, 6.0f)));
    public static final Block CUT_SANDSTONE_SLAB = Blocks.register("cut_sandstone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).method_29292().strength(2.0f, 6.0f)));
    public static final Block PETRIFIED_OAK_SLAB = Blocks.register("petrified_oak_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.WOOD).method_29292().strength(2.0f, 6.0f)));
    public static final Block COBBLESTONE_SLAB = Blocks.register("cobblestone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).method_29292().strength(2.0f, 6.0f)));
    public static final Block BRICK_SLAB = Blocks.register("brick_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).method_29292().strength(2.0f, 6.0f)));
    public static final Block STONE_BRICK_SLAB = Blocks.register("stone_brick_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).method_29292().strength(2.0f, 6.0f)));
    public static final Block NETHER_BRICK_SLAB = Blocks.register("nether_brick_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    public static final Block QUARTZ_SLAB = Blocks.register("quartz_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).method_29292().strength(2.0f, 6.0f)));
    public static final Block RED_SANDSTONE_SLAB = Blocks.register("red_sandstone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).method_29292().strength(2.0f, 6.0f)));
    public static final Block CUT_RED_SANDSTONE_SLAB = Blocks.register("cut_red_sandstone_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).method_29292().strength(2.0f, 6.0f)));
    public static final Block PURPUR_SLAB = Blocks.register("purpur_slab", new SlabBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.MAGENTA).method_29292().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_STONE = Blocks.register("smooth_stone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.STONE).method_29292().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_SANDSTONE = Blocks.register("smooth_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).method_29292().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_QUARTZ = Blocks.register("smooth_quartz", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.QUARTZ).method_29292().strength(2.0f, 6.0f)));
    public static final Block SMOOTH_RED_SANDSTONE = Blocks.register("smooth_red_sandstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.ORANGE).method_29292().strength(2.0f, 6.0f)));
    ...
    public static final Block END_ROD = Blocks.register("end_rod", new EndRodBlock(AbstractBlock.Settings.of(Material.SUPPORTED).breakInstantly().lightLevel(arg -> 14).sounds(BlockSoundGroup.WOOD).nonOpaque()));
    ...
    public static final Block PURPUR_BLOCK = Blocks.register("purpur_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.MAGENTA).method_29292().strength(1.5f, 6.0f)));
    public static final Block PURPUR_PILLAR = Blocks.register("purpur_pillar", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.MAGENTA).method_29292().strength(1.5f, 6.0f)));
    ...
    public static final Block END_STONE_BRICKS = Blocks.register("end_stone_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).method_29292().strength(3.0f, 9.0f)));
    ...
    public static final Block GRASS_PATH = Blocks.register("grass_path", new GrassPathBlock(AbstractBlock.Settings.of(Material.SOIL).strength(0.65f).sounds(BlockSoundGroup.GRASS).blockVision(Blocks::always)));
    ...
    public static final Block REPEATING_COMMAND_BLOCK = Blocks.register("repeating_command_block", new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.PURPLE).method_29292().strength(-1.0f, 3600000.0f).dropsNothing()));
    public static final Block CHAIN_COMMAND_BLOCK = Blocks.register("chain_command_block", new CommandBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.GREEN).method_29292().strength(-1.0f, 3600000.0f).dropsNothing()));
    ...
    public static final Block MAGMA_BLOCK = Blocks.register("magma_block", new MagmaBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().lightLevel(arg -> 3).ticksRandomly().strength(0.5f).allowsSpawning((arg, arg2, arg3, arg4) -> arg4.isFireImmune()).postProcess(Blocks::always).emissiveLighting(Blocks::always)));
    ...
    public static final Block RED_NETHER_BRICKS = Blocks.register("red_nether_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    public static final Block BONE_BLOCK = Blocks.register("bone_block", new PillarBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.SAND).method_29292().strength(2.0f).sounds(BlockSoundGroup.BONE)));
    ...
    public static final Block OBSERVER = Blocks.register("observer", new ObserverBlock(AbstractBlock.Settings.of(Material.STONE).strength(3.0f).method_29292().solidBlock(Blocks::never)));
    ...
    public static final Block WHITE_GLAZED_TERRACOTTA = Blocks.register("white_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.WHITE).method_29292().strength(1.4f)));
    public static final Block ORANGE_GLAZED_TERRACOTTA = Blocks.register("orange_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.ORANGE).method_29292().strength(1.4f)));
    public static final Block MAGENTA_GLAZED_TERRACOTTA = Blocks.register("magenta_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.MAGENTA).method_29292().strength(1.4f)));
    public static final Block LIGHT_BLUE_GLAZED_TERRACOTTA = Blocks.register("light_blue_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.LIGHT_BLUE).method_29292().strength(1.4f)));
    public static final Block YELLOW_GLAZED_TERRACOTTA = Blocks.register("yellow_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.YELLOW).method_29292().strength(1.4f)));
    public static final Block LIME_GLAZED_TERRACOTTA = Blocks.register("lime_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.LIME).method_29292().strength(1.4f)));
    public static final Block PINK_GLAZED_TERRACOTTA = Blocks.register("pink_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.PINK).method_29292().strength(1.4f)));
    public static final Block GRAY_GLAZED_TERRACOTTA = Blocks.register("gray_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.GRAY).method_29292().strength(1.4f)));
    public static final Block LIGHT_GRAY_GLAZED_TERRACOTTA = Blocks.register("light_gray_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.LIGHT_GRAY).method_29292().strength(1.4f)));
    public static final Block CYAN_GLAZED_TERRACOTTA = Blocks.register("cyan_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.CYAN).method_29292().strength(1.4f)));
    public static final Block PURPLE_GLAZED_TERRACOTTA = Blocks.register("purple_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.PURPLE).method_29292().strength(1.4f)));
    public static final Block BLUE_GLAZED_TERRACOTTA = Blocks.register("blue_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.BLUE).method_29292().strength(1.4f)));
    public static final Block BROWN_GLAZED_TERRACOTTA = Blocks.register("brown_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.BROWN).method_29292().strength(1.4f)));
    public static final Block GREEN_GLAZED_TERRACOTTA = Blocks.register("green_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.GREEN).method_29292().strength(1.4f)));
    public static final Block RED_GLAZED_TERRACOTTA = Blocks.register("red_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.RED).method_29292().strength(1.4f)));
    public static final Block BLACK_GLAZED_TERRACOTTA = Blocks.register("black_glazed_terracotta", new GlazedTerracottaBlock(AbstractBlock.Settings.of(Material.STONE, DyeColor.BLACK).method_29292().strength(1.4f)));
    public static final Block WHITE_CONCRETE = Blocks.register("white_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.WHITE).method_29292().strength(1.8f)));
    public static final Block ORANGE_CONCRETE = Blocks.register("orange_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.ORANGE).method_29292().strength(1.8f)));
    public static final Block MAGENTA_CONCRETE = Blocks.register("magenta_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.MAGENTA).method_29292().strength(1.8f)));
    public static final Block LIGHT_BLUE_CONCRETE = Blocks.register("light_blue_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.LIGHT_BLUE).method_29292().strength(1.8f)));
    public static final Block YELLOW_CONCRETE = Blocks.register("yellow_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.YELLOW).method_29292().strength(1.8f)));
    public static final Block LIME_CONCRETE = Blocks.register("lime_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.LIME).method_29292().strength(1.8f)));
    public static final Block PINK_CONCRETE = Blocks.register("pink_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.PINK).method_29292().strength(1.8f)));
    public static final Block GRAY_CONCRETE = Blocks.register("gray_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.GRAY).method_29292().strength(1.8f)));
    public static final Block LIGHT_GRAY_CONCRETE = Blocks.register("light_gray_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.LIGHT_GRAY).method_29292().strength(1.8f)));
    public static final Block CYAN_CONCRETE = Blocks.register("cyan_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.CYAN).method_29292().strength(1.8f)));
    public static final Block PURPLE_CONCRETE = Blocks.register("purple_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.PURPLE).method_29292().strength(1.8f)));
    public static final Block BLUE_CONCRETE = Blocks.register("blue_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.BLUE).method_29292().strength(1.8f)));
    public static final Block BROWN_CONCRETE = Blocks.register("brown_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.BROWN).method_29292().strength(1.8f)));
    public static final Block GREEN_CONCRETE = Blocks.register("green_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.GREEN).method_29292().strength(1.8f)));
    public static final Block RED_CONCRETE = Blocks.register("red_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.RED).method_29292().strength(1.8f)));
    public static final Block BLACK_CONCRETE = Blocks.register("black_concrete", new Block(AbstractBlock.Settings.of(Material.STONE, DyeColor.BLACK).method_29292().strength(1.8f)));
    ...
    public static final Block DEAD_TUBE_CORAL_BLOCK = Blocks.register("dead_tube_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().strength(1.5f, 6.0f)));
    public static final Block DEAD_BRAIN_CORAL_BLOCK = Blocks.register("dead_brain_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().strength(1.5f, 6.0f)));
    public static final Block DEAD_BUBBLE_CORAL_BLOCK = Blocks.register("dead_bubble_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().strength(1.5f, 6.0f)));
    public static final Block DEAD_FIRE_CORAL_BLOCK = Blocks.register("dead_fire_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().strength(1.5f, 6.0f)));
    public static final Block DEAD_HORN_CORAL_BLOCK = Blocks.register("dead_horn_coral_block", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().strength(1.5f, 6.0f)));
    public static final Block TUBE_CORAL_BLOCK = Blocks.register("tube_coral_block", new CoralBlockBlock(DEAD_TUBE_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLUE).method_29292().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block BRAIN_CORAL_BLOCK = Blocks.register("brain_coral_block", new CoralBlockBlock(DEAD_BRAIN_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.PINK).method_29292().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block BUBBLE_CORAL_BLOCK = Blocks.register("bubble_coral_block", new CoralBlockBlock(DEAD_BUBBLE_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.PURPLE).method_29292().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block FIRE_CORAL_BLOCK = Blocks.register("fire_coral_block", new CoralBlockBlock(DEAD_FIRE_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).method_29292().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block HORN_CORAL_BLOCK = Blocks.register("horn_coral_block", new CoralBlockBlock(DEAD_HORN_CORAL_BLOCK, AbstractBlock.Settings.of(Material.STONE, MaterialColor.YELLOW).method_29292().strength(1.5f, 6.0f).sounds(BlockSoundGroup.CORAL)));
    public static final Block DEAD_TUBE_CORAL = Blocks.register("dead_tube_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    public static final Block DEAD_BRAIN_CORAL = Blocks.register("dead_brain_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    public static final Block DEAD_BUBBLE_CORAL = Blocks.register("dead_bubble_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    public static final Block DEAD_FIRE_CORAL = Blocks.register("dead_fire_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    public static final Block DEAD_HORN_CORAL = Blocks.register("dead_horn_coral", new DeadCoralBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    ...
    public static final Block DEAD_TUBE_CORAL_FAN = Blocks.register("dead_tube_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    public static final Block DEAD_BRAIN_CORAL_FAN = Blocks.register("dead_brain_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    public static final Block DEAD_BUBBLE_CORAL_FAN = Blocks.register("dead_bubble_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    public static final Block DEAD_FIRE_CORAL_FAN = Blocks.register("dead_fire_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    public static final Block DEAD_HORN_CORAL_FAN = Blocks.register("dead_horn_coral_fan", new DeadCoralFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly()));
    ...
    public static final Block DEAD_TUBE_CORAL_WALL_FAN = Blocks.register("dead_tube_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly().dropsLike(DEAD_TUBE_CORAL_FAN)));
    public static final Block DEAD_BRAIN_CORAL_WALL_FAN = Blocks.register("dead_brain_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly().dropsLike(DEAD_BRAIN_CORAL_FAN)));
    public static final Block DEAD_BUBBLE_CORAL_WALL_FAN = Blocks.register("dead_bubble_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly().dropsLike(DEAD_BUBBLE_CORAL_FAN)));
    public static final Block DEAD_FIRE_CORAL_WALL_FAN = Blocks.register("dead_fire_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly().dropsLike(DEAD_FIRE_CORAL_FAN)));
    public static final Block DEAD_HORN_CORAL_WALL_FAN = Blocks.register("dead_horn_coral_wall_fan", new DeadCoralWallFanBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.GRAY).method_29292().noCollision().breakInstantly().dropsLike(DEAD_HORN_CORAL_FAN)));
    ...
    public static final Block SMOKER = Blocks.register("smoker", new SmokerBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(3.5f).lightLevel(Blocks.createLightLevelFromBlockState(13))));
    public static final Block BLAST_FURNACE = Blocks.register("blast_furnace", new BlastFurnaceBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(3.5f).lightLevel(Blocks.createLightLevelFromBlockState(13))));
    ...
    public static final Block GRINDSTONE = Blocks.register("grindstone", new GrindstoneBlock(AbstractBlock.Settings.of(Material.REPAIR_STATION, MaterialColor.IRON).method_29292().strength(2.0f, 6.0f).sounds(BlockSoundGroup.STONE)));
    ...
    public static final Block STONECUTTER = Blocks.register("stonecutter", new StonecutterBlock(AbstractBlock.Settings.of(Material.STONE).method_29292().strength(3.5f)));
    public static final Block BELL = Blocks.register("bell", new BellBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.GOLD).method_29292().strength(5.0f).sounds(BlockSoundGroup.ANVIL)));
    public static final Block LANTERN = Blocks.register("lantern", new LanternBlock(AbstractBlock.Settings.of(Material.METAL).method_29292().strength(3.5f).sounds(BlockSoundGroup.LANTERN).lightLevel(arg -> 15).nonOpaque()));
    public static final Block SOUL_LANTERN = Blocks.register("soul_lantern", new LanternBlock(AbstractBlock.Settings.of(Material.METAL).method_29292().strength(3.5f).sounds(BlockSoundGroup.LANTERN).lightLevel(arg -> 10).nonOpaque()));
    public static final Block CAMPFIRE = Blocks.register("campfire", new CampfireBlock(true, 1, AbstractBlock.Settings.of(Material.WOOD, MaterialColor.SPRUCE).strength(2.0f).sounds(BlockSoundGroup.WOOD).lightLevel(Blocks.createLightLevelFromBlockState(15)).nonOpaque()));
    public static final Block SOUL_CAMPFIRE = Blocks.register("soul_campfire", new CampfireBlock(false, 2, AbstractBlock.Settings.of(Material.WOOD, MaterialColor.SPRUCE).strength(2.0f).sounds(BlockSoundGroup.WOOD).lightLevel(Blocks.createLightLevelFromBlockState(10)).nonOpaque()));
    ...
    public static final Block WARPED_NYLIUM = Blocks.register("warped_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.CYAN).method_29292().strength(0.4f).sounds(BlockSoundGroup.NYLIUM).ticksRandomly()));
    ...
    public static final Block WARPED_WART_BLOCK = Blocks.register("warped_wart_block", new Block(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.CYAN).strength(1.0f).sounds(BlockSoundGroup.WART_BLOCK)));
    ...
    public static final Block CRIMSON_NYLIUM = Blocks.register("crimson_nylium", new NyliumBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.RED).method_29292().strength(0.4f).sounds(BlockSoundGroup.NYLIUM).ticksRandomly()));
    ...
    public static final Block SHROOMLIGHT = Blocks.register("shroomlight", new Block(AbstractBlock.Settings.of(Material.SOLID_ORGANIC, MaterialColor.RED).strength(1.0f).sounds(BlockSoundGroup.SHROOMLIGHT).lightLevel(arg -> 15)));
    ...
    public static final Block CRIMSON_BUTTON = Blocks.register("crimson_button", new WoodButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    public static final Block WARPED_BUTTON = Blocks.register("warped_button", new WoodButtonBlock(AbstractBlock.Settings.of(Material.SUPPORTED).noCollision().strength(0.5f).sounds(BlockSoundGroup.WOOD)));
    ...
    public static final Block STRUCTURE_BLOCK = Blocks.register("structure_block", new StructureBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.LIGHT_GRAY).method_29292().strength(-1.0f, 3600000.0f).dropsNothing()));
    public static final Block JIGSAW = Blocks.register("jigsaw", new JigsawBlock(AbstractBlock.Settings.of(Material.METAL, MaterialColor.LIGHT_GRAY).method_29292().strength(-1.0f, 3600000.0f).dropsNothing()));
    ...
    public static final Block CRYING_OBSIDIAN = Blocks.register("crying_obsidian", new CryingObsidianBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).method_29292().strength(50.0f, 1200.0f).lightLevel(arg -> 10)));
    public static final Block RESPAWN_ANCHOR = Blocks.register("respawn_anchor", new RespawnAnchorBlock(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).method_29292().strength(50.0f, 1200.0f).lightLevel(arg -> RespawnAnchorBlock.getLightLevel(arg, 15)).nonOpaque()));
    ...
    public static final Block LODESTONE = Blocks.register("lodestone", new Block(AbstractBlock.Settings.of(Material.REPAIR_STATION).method_29292().strength(3.5f).sounds(BlockSoundGroup.LODESTONE)));
    public static final Block BLACKSTONE = Blocks.register("blackstone", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).method_29292().strength(1.5f, 6.0f)));
    ...
    public static final Block POLISHED_BLACKSTONE_PRESSURE_PLATE = Blocks.register("polished_blackstone_pressure_plate", new PressurePlateBlock(PressurePlateBlock.ActivationRule.MOBS, AbstractBlock.Settings.of(Material.STONE, MaterialColor.BLACK).method_29292().noCollision().strength(0.5f)));
    ...
    public static final Block CHISELED_NETHER_BRICKS = Blocks.register("chiseled_nether_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
    public static final Block CRACKED_NETHER_BRICKS = Blocks.register("cracked_nether_bricks", new Block(AbstractBlock.Settings.of(Material.STONE, MaterialColor.NETHER).method_29292().strength(2.0f, 6.0f).sounds(BlockSoundGroup.NETHER_BRICKS)));
