...
extends MiningToolItem {
    private static final Set<Material> field_23139 = Sets.newHashSet((Object[])new Material[]{Material.WOOD, Material.NETHER_WOOD, Material.PLANT, Material.REPLACEABLE_PLANT, Material.BAMBOO, Material.PUMPKIN});
