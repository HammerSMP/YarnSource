...
public class class_5441
extends Decorator<NoiseHeightmapDecoratorConfig> {
    public class_5441(Codec<NoiseHeightmapDecoratorConfig> codec) {
        super(codec);
    }

    @Override
    public Stream<BlockPos> getPositions(class_5444 arg, Random random, NoiseHeightmapDecoratorConfig arg2, BlockPos arg3) {
