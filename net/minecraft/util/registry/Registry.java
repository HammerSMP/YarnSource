...
IndexedIterable<T> {
    ...
    public static final RegistryKey<Registry<class_5338>> LOOT_POOL_ENTRY_TYPE = Registry.createRegistryKey("loot_pool_entry_type");
    public static final RegistryKey<Registry<class_5339>> LOOT_FUNCTION_TYPE = Registry.createRegistryKey("loot_function_type");
    public static final RegistryKey<Registry<class_5342>> LOOT_CONDITION_TYPE = Registry.createRegistryKey("loot_condition_type");
    ...
    public static final Registry<class_5338> field_25293 = Registry.create(LOOT_POOL_ENTRY_TYPE, () -> LootEntries.EMPTY);
    public static final Registry<class_5339> field_25294 = Registry.create(LOOT_FUNCTION_TYPE, () -> LootFunctions.SET_COUNT);
    public static final Registry<class_5342> field_25299 = Registry.create(LOOT_CONDITION_TYPE, () -> LootConditions.INVERTED);
