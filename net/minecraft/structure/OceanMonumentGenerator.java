...
public class OceanMonumentGenerator {
    ...
    extends Piece {
        ...
        private void method_14761(boolean bl, int i, IWorld arg, Random random, BlockBox arg2) {
            int j = 24;
        ...
        private void method_14763(IWorld arg, Random random, BlockBox arg2) {
        ...
        private void method_14762(IWorld arg, Random random, BlockBox arg2) {
        ...
        private void method_14765(IWorld arg, Random random, BlockBox arg2) {
        ...
        private void method_14764(IWorld arg, Random random, BlockBox arg2) {
        ...
        private void method_14766(IWorld arg, Random random, BlockBox arg2) {
        ...
        private void method_14767(IWorld arg, Random random, BlockBox arg2) {
    ...
    extends StructurePiece {
        ...
        protected void setAirAndWater(IWorld arg, BlockBox arg2, int i, int j, int k, int l, int m, int n) {
            for (int o = j; o <= m; ++o) {
                for (int p = i; p <= l; ++p) {
                    for (int q = k; q <= n; ++q) {
        ...
        protected void method_14774(IWorld arg, BlockBox arg2, int i, int j, boolean bl) {
            if (bl) {
        ...
        protected void method_14771(IWorld arg, BlockBox arg2, int i, int j, int k, int l, int m, int n, BlockState arg3) {
            for (int o = j; o <= m; ++o) {
                for (int p = i; p <= l; ++p) {
                    for (int q = k; q <= n; ++q) {
        ...
        protected boolean method_14772(IWorld arg, BlockBox arg2, int i, int j, int k) {
            int n;
            int m;
            ...
            if (arg2.contains(new BlockPos(l, m = this.applyYTransform(j), n = this.applyZTransform(i, k)))) {
                ...
                lv.initialize(arg, arg.getLocalDifficulty(lv.getBlockPos()), SpawnType.STRUCTURE, null, null);
                arg.spawnEntity(lv);
                return true;
            }
            return false;
