...
public interface StructurePieceType {
    ...
    public static StructurePieceType register(StructurePieceType arg, String string) {
        return Registry.register(Registry.STRUCTURE_PIECE, string.toLowerCase(Locale.ROOT), arg);
    }
}
