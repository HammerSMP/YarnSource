...
extends RuleTest {
    public static final Codec<TagMatchRuleTest> field_25014 = Tag.method_28134(TagContainers.instance()::blocks).fieldOf("tag").xmap(TagMatchRuleTest::new, arg -> arg.tag).codec();
