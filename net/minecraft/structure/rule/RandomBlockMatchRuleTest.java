...
extends RuleTest {
    public static final Codec<RandomBlockMatchRuleTest> field_25009 = RecordCodecBuilder.create(instance -> instance.group((App)Registry.BLOCK.fieldOf("block").forGetter(arg -> arg.block), (App)Codec.FLOAT.fieldOf("probability").forGetter(arg -> Float.valueOf(arg.probability))).apply((Applicative)instance, RandomBlockMatchRuleTest::new));
