...
extends PosRuleTest {
    public static final Codec<AxisAlignedLinearPosRuleTest> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Codec.FLOAT.fieldOf("min_chance").orElse((Object)Float.valueOf(0.0f)).forGetter(arg -> Float.valueOf(arg.minChance)), (App)Codec.FLOAT.fieldOf("max_chance").orElse((Object)Float.valueOf(0.0f)).forGetter(arg -> Float.valueOf(arg.maxChance)), (App)Codec.INT.fieldOf("min_dist").orElse((Object)0).forGetter(arg -> arg.minDistance), (App)Codec.INT.fieldOf("max_dist").orElse((Object)0).forGetter(arg -> arg.maxDistance), (App)Direction.Axis.field_25065.fieldOf("axis").orElse((Object)Direction.Axis.Y).forGetter(arg -> arg.axis)).apply((Applicative)instance, AxisAlignedLinearPosRuleTest::new));
