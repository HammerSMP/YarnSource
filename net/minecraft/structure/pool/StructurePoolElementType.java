...
extends DynamicDeserializer<StructurePoolElement> {
    ...
    public static StructurePoolElementType register(String string, StructurePoolElementType arg) {
        return Registry.register(Registry.STRUCTURE_POOL_ELEMENT, string, arg);
    }
}
