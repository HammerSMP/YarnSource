...
public class HoglinBrain {
    ...
    private static void playSound(HoglinEntity arg) {
    ...
    protected static void playSoundAtChance(HoglinEntity arg) {
    ...
    protected static boolean hasIdleActivity(HoglinEntity arg) {
