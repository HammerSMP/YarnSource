        ...
        for (EntityPose lv4 : immutableList) {
            ...
            while (unmodifiableIterator.hasNext()) {
                ...
                for (int[] js : is) {
                    ...
                    if (!class_5275.method_27932(d) || !class_5275.method_27933(this.world, arg2, (lv6 = new Box(-f, d, -f, f, d + (double)lv5.height, f)).offset(lv7 = Vec3d.method_26410(lv3, d)))) continue;
                    arg2.setPose(lv4);
                    return lv7;
                }
            }
