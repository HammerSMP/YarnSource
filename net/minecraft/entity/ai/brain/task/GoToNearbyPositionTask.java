...
extends Task<MobEntityWithAi> {
    ...
    protected boolean shouldRun(ServerWorld arg, MobEntityWithAi arg2) {
        ...
        return optional.isPresent() && Objects.equals(arg.getDimension().getType(), optional.get().getDimension()) && optional.get().getPos().isWithinDistance(arg2.getPos(), (double)this.maxDistance);
    }
