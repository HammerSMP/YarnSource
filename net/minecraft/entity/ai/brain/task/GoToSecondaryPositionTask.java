...
extends Task<VillagerEntity> {
    ...
    protected boolean shouldRun(ServerWorld arg, VillagerEntity arg2) {
        ...
        if (optional.isPresent() && optional2.isPresent() && !(list = optional.get()).isEmpty()) {
            ...
            return this.chosenPosition != null && Objects.equals(arg.getDimension().getType(), this.chosenPosition.getDimension()) && optional2.get().getPos().isWithinDistance(arg2.getPos(), (double)this.primaryPositionActivationDistance);
        }
        return false;
    }
