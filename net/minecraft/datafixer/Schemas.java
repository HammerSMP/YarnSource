...
public class Schemas {
    ...
    private static void build(DataFixerBuilder builder) {
        ...
        builder.addFixer(BlockNameFix.create(schema53, "Flowing fixer", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:flowing_water", (Object)"minecraft:water", (Object)"minecraft:flowing_lava", (Object)"minecraft:lava"))));
        ...
        builder.addFixer(ItemNameFix.create(schema57, "Rename seagrass items", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:sea_grass", (Object)"minecraft:seagrass", (Object)"minecraft:tall_sea_grass", (Object)"minecraft:tall_seagrass"))));
        builder.addFixer(BlockNameFix.create(schema57, "Rename seagrass blocks", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:sea_grass", (Object)"minecraft:seagrass", (Object)"minecraft:tall_sea_grass", (Object)"minecraft:tall_seagrass"))));
        ...
        builder.addFixer(ItemNameFix.create(schema59, "Rename prismarine_brick(s)_* blocks", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:prismarine_bricks_slab", (Object)"minecraft:prismarine_brick_slab", (Object)"minecraft:prismarine_bricks_stairs", (Object)"minecraft:prismarine_brick_stairs"))));
        builder.addFixer(BlockNameFix.create(schema59, "Rename prismarine_brick(s)_* items", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:prismarine_bricks_slab", (Object)"minecraft:prismarine_brick_slab", (Object)"minecraft:prismarine_bricks_stairs", (Object)"minecraft:prismarine_brick_stairs"))));
        Schema schema60 = builder.addSchema(1488, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(BlockNameFix.create(schema60, "Rename kelp/kelptop", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:kelp_top", (Object)"minecraft:kelp", (Object)"minecraft:kelp", (Object)"minecraft:kelp_plant"))));
        ...
        builder.addFixer((DataFix)new SwimStatsRenameFix(schema69, false));
        ...
        builder.addFixer(BlockNameFix.create(schema75, "Rename sign blocks & stone slabs", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:stone_slab", (Object)"minecraft:smooth_stone_slab", (Object)"minecraft:sign", (Object)"minecraft:oak_sign", (Object)"minecraft:wall_sign", (Object)"minecraft:oak_wall_sign"))));
        builder.addFixer(ItemNameFix.create(schema75, "Rename sign item & stone slabs", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:stone_slab", (Object)"minecraft:smooth_stone_slab", (Object)"minecraft:sign", (Object)"minecraft:oak_sign"))));
        ...
        builder.addFixer((DataFix)new CatTypeFix(schema82, false));
        Schema schema83 = builder.addSchema(1918, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new VillagerProfessionFix(schema83, "minecraft:villager"));
        builder.addFixer((DataFix)new VillagerProfessionFix(schema83, "minecraft:zombie_villager"));
        Schema schema84 = builder.addSchema(1920, Schema1920::new);
        builder.addFixer((DataFix)new NewVillageFix(schema84, false));
        builder.addFixer((DataFix)new ChoiceTypesFix(schema84, "Add campfire", TypeReferences.BLOCK_ENTITY));
        Schema schema85 = builder.addSchema(1925, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new MapIdFix(schema85, false));
        Schema schema86 = builder.addSchema(1928, Schema1928::new);
        builder.addFixer((DataFix)new EntityRavagerRenameFix(schema86, true));
        ...
        builder.addFixer((DataFix)new ChoiceTypesFix(schema87, "Add Wandering Trader and Trader Llama", TypeReferences.ENTITY));
        Schema schema88 = builder.addSchema(1931, Schema1931::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema88, "Added Fox", TypeReferences.ENTITY));
        Schema schema89 = builder.addSchema(1936, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new OptionsAddTextBackgroundFix(schema89, false));
        Schema schema90 = builder.addSchema(1946, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new PointOfInterestReorganizationFix(schema90, false));
        Schema schema91 = builder.addSchema(1948, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new OminousBannerItemRenameFix(schema91, false));
        Schema schema92 = builder.addSchema(1953, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new OminousBannerBlockEntityRenameFix(schema92, false));
        Schema schema93 = builder.addSchema(1955, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new VillagerXpRebuildFix(schema93, false));
        builder.addFixer((DataFix)new ZombieVillagerXpRebuildFix(schema93, false));
        Schema schema94 = builder.addSchema(1961, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new ChunkLightRemoveFix(schema94, false));
        Schema schema95 = builder.addSchema(1963, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new RemoveGolemGossipFix(schema95, false));
        Schema schema96 = builder.addSchema(2100, Schema2100::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema96, "Added Bee and Bee Stinger", TypeReferences.ENTITY));
        builder.addFixer((DataFix)new ChoiceTypesFix(schema96, "Add beehive", TypeReferences.BLOCK_ENTITY));
        builder.addFixer((DataFix)new RecipeRenameFix(schema96, false, "Rename sugar recipe", Schemas.method_30068("minecraft:sugar", "sugar_from_sugar_cane")));
        builder.addFixer((DataFix)new AdvancementRenameFix(schema96, false, "Rename sugar recipe advancement", Schemas.method_30068("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
        Schema schema97 = builder.addSchema(2202, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new BiomeFormatFix(schema97, false));
        ...
        builder.addFixer((DataFix)new BeehiveRenameFix(schema98));
        ...
        builder.addFixer((DataFix)new StructureReferenceFix(schema99, false));
        Schema schema100 = builder.addSchema(2218, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new RemovePoiValidTagFix(schema100, false));
        Schema schema101 = builder.addSchema(2501, Schema2501::new);
        builder.addFixer((DataFix)new FurnaceRecipesFix(schema101, true));
        Schema schema102 = builder.addSchema(2502, Schema2502::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema102, "Added Hoglin", TypeReferences.ENTITY));
        Schema schema103 = builder.addSchema(2503, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new WallPropertyFix(schema103, false));
        builder.addFixer((DataFix)new AdvancementRenameFix(schema103, false, "Composter category change", Schemas.method_30068("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
        Schema schema104 = builder.addSchema(2505, Schema2505::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema104, "Added Piglin", TypeReferences.ENTITY));
        builder.addFixer((DataFix)new MemoryExpiryDataFix(schema104, "minecraft:villager"));
        Schema schema105 = builder.addSchema(2508, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer(ItemNameFix.create(schema105, "Renamed fungi items to fungus", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:warped_fungi", (Object)"minecraft:warped_fungus", (Object)"minecraft:crimson_fungi", (Object)"minecraft:crimson_fungus"))));
        builder.addFixer(BlockNameFix.create(schema105, "Renamed fungi blocks to fungus", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:warped_fungi", (Object)"minecraft:warped_fungus", (Object)"minecraft:crimson_fungi", (Object)"minecraft:crimson_fungus"))));
        Schema schema106 = builder.addSchema(2509, Schema2509::new);
        builder.addFixer((DataFix)new EntityZombifiedPiglinRenameFix(schema106));
        ...
        builder.addFixer((DataFix)new EntityProjectileOwnerFix(schema107));
        ...
        builder.addFixer((DataFix)new JigsawRotationFix(schema110, false));
        ...
        builder.addFixer((DataFix)new RenameItemStackAttributesFix(schema113));
        ...
        builder.addFixer(ItemNameFix.create(schema115, "Rename soul fire torch and soul fire lantern", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:soul_fire_torch", (Object)"minecraft:soul_torch", (Object)"minecraft:soul_fire_lantern", (Object)"minecraft:soul_lantern"))));
        ...
        builder.addFixer((DataFix)new StructureSeparationDataFix(schema120));
        Schema schema121 = builder.addSchema(2551, Schema2551::new);
        builder.addFixer((DataFix)new WriteAndReadFix(schema121, "add types to WorldGenData", TypeReferences.CHUNK_GENERATOR_SETTINGS));
        Schema schema122 = builder.addSchema(2552, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new BiomeRenameFix(schema122, false, "Nether biome rename", (Map<String, String>)ImmutableMap.of((Object)"minecraft:nether", (Object)"minecraft:nether_wastes")));
        Schema schema123 = builder.addSchema(2553, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new BiomesFix(schema123, false));
        Schema schema124 = builder.addSchema(2558, EMPTY_IDENTIFIER_NORMALIZE);
        builder.addFixer((DataFix)new MissingDimensionFix(schema124, false));
        builder.addFixer((DataFix)new OptionFix(schema124, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
        Schema schema125 = builder.addSchema(2568, Schema2568::new);
        builder.addFixer((DataFix)new ChoiceTypesFix(schema125, "Added Piglin Brute", TypeReferences.ENTITY));
    }
