...
import net.minecraft.class_5429;
...
public class Schemas {
    ...
    private static void build(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer((DataFix)new class_5429(schema95, false));
        ...
        dataFixerBuilder.addFixer((DataFix)new RecipeRenameFix(schema96, false, "Rename sugar recipe", Schemas.method_30068("minecraft:sugar", "sugar_from_sugar_cane")));
        dataFixerBuilder.addFixer((DataFix)new AdvancementRenameFix(schema96, false, "Rename sugar recipe advancement", Schemas.method_30068("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
        ...
        dataFixerBuilder.addFixer(ItemNameFix.create(schema98, "Rename bee_hive item to beehive", Schemas.method_30068("minecraft:bee_hive", "minecraft:beehive")));
        dataFixerBuilder.addFixer((DataFix)new BeehiveRenameFix(schema98));
        dataFixerBuilder.addFixer(BlockNameFix.create(schema98, "Rename bee_hive block to beehive", Schemas.method_30068("minecraft:bee_hive", "minecraft:beehive")));
        ...
        dataFixerBuilder.addFixer((DataFix)new AdvancementRenameFix(schema103, false, "Composter category change", Schemas.method_30068("minecraft:recipes/misc/composter", "minecraft:recipes/decorations/composter")));
        ...
        dataFixerBuilder.addFixer(ItemNameFix.create(schema105, "Renamed fungi items to fungus", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:warped_fungi", (Object)"minecraft:warped_fungus", (Object)"minecraft:crimson_fungi", (Object)"minecraft:crimson_fungus"))));
        dataFixerBuilder.addFixer(BlockNameFix.create(schema105, "Renamed fungi blocks to fungus", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:warped_fungi", (Object)"minecraft:warped_fungus", (Object)"minecraft:crimson_fungi", (Object)"minecraft:crimson_fungus"))));
        ...
        dataFixerBuilder.addFixer(ItemNameFix.create(schema106, "Rename zombie pigman egg item", Schemas.method_30070(EntityZombifiedPiglinRenameFix.RENAMES)));
        ...
        dataFixerBuilder.addFixer(ItemNameFix.create(schema115, "Rename soul fire torch and soul fire lantern", Schemas.method_30070((Map<String, String>)ImmutableMap.of((Object)"minecraft:soul_fire_torch", (Object)"minecraft:soul_torch", (Object)"minecraft:soul_fire_lantern", (Object)"minecraft:soul_lantern"))));
        ...
        dataFixerBuilder.addFixer((DataFix)new StructureSeparationDataFix(schema120));
        Schema schema121 = dataFixerBuilder.addSchema(2551, Schema2551::new);
        dataFixerBuilder.addFixer((DataFix)new WriteAndReadFix(schema121, "add types to WorldGenData", TypeReferences.CHUNK_GENERATOR_SETTINGS));
        Schema schema122 = dataFixerBuilder.addSchema(2552, EMPTY_IDENTIFIER_NORMALIZE);
        dataFixerBuilder.addFixer((DataFix)new BiomeRenameFix(schema122, false, "Nether biome rename", (Map<String, String>)ImmutableMap.of((Object)"minecraft:nether", (Object)"minecraft:nether_wastes")));
        Schema schema123 = dataFixerBuilder.addSchema(2553, EMPTY_IDENTIFIER_NORMALIZE);
        dataFixerBuilder.addFixer((DataFix)new BiomesFix(schema123, false));
        ...
        dataFixerBuilder.addFixer((DataFix)new OptionFix(schema124, false, "Rename swapHands setting", "key_key.swapHands", "key_key.swapOffhand"));
        Schema schema125 = dataFixerBuilder.addSchema(2568, Schema2568::new);
        dataFixerBuilder.addFixer((DataFix)new ChoiceTypesFix(schema125, "Added Piglin Brute", TypeReferences.ENTITY));
    }
