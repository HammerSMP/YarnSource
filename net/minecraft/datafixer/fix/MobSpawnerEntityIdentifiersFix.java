...
extends DataFix {
    ...
    private Dynamic<?> fixSpawner(Dynamic<?> dynamic2) {
        ...
        Optional optional = dynamic2.get("EntityId").asString();
        if (optional.isPresent()) {
            Dynamic dynamic22 = (Dynamic)DataFixUtils.orElse((Optional)dynamic2.get("SpawnData").get(), (Object)dynamic2.emptyMap());
