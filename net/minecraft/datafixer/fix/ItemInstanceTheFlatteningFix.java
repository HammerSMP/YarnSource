...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, typed -> {
            ...
            if (string != null) {
                typed2 = typed2.set(opticFinder, (Object)Pair.of((Object)TypeReferences.ITEM_NAME.typeName(), (Object)string));
            }
    ...
    public static String getItem(@Nullable String string, int i) {
        if (ORIGINAL_ITEM_NAMES.contains(string)) {
            String string2 = FLATTENING_MAP.get(string + '.' + i);
            return string2 == null ? FLATTENING_MAP.get(string + ".0") : string2;
        }
        return null;
    }
}
