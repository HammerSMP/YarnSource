...
extends DataFix {
    private static final String[] ID_TO_POTIONS = (String[])DataFixUtils.make((Object)new String[128], strings -> {
        ...
        return this.fixTypeEverywhereTyped("ItemPotionFix", type, typed -> {
            ...
            if (optional.isPresent() && Objects.equals(((Pair)optional.get()).getSecond(), "minecraft:potion")) {
                ...
                if (optional2.isPresent()) {
                    ...
                    Optional optional3 = dynamic2.get("Potion").asString();
                    if (!optional3.isPresent()) {
                        String string;
                        Typed typed3 = ((Typed)optional2.get()).set(DSL.remainderFinder(), (Object)dynamic2.set("Potion", dynamic2.createString((string = ID_TO_POTIONS[s & 0x7F]) == null ? "minecraft:water" : string)));
                        typed2 = typed2.set(opticFinder2, typed3);
                        if ((s & 0x4000) == 16384) {
                            typed2 = typed2.set(opticFinder, (Object)Pair.of((Object)TypeReferences.ITEM_NAME.typeName(), (Object)"minecraft:splash_potion"));
                        }
                    }
                    if (s != 0) {
