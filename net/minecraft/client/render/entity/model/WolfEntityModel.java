...
extends TintableAnimalModel<T> {
    ...
    public void animateModel(T arg, float f, float g, float h) {
        this.tail.yaw = arg.method_29511() ? 0.0f : MathHelper.cos(f * 0.6662f) * 1.4f * g;
        ...
        this.field_20788.roll = ((WolfEntity)arg).getBegAnimationProgress(h) + ((WolfEntity)arg).getShakeAnimationProgress(h, 0.0f);
        ...
        this.field_20789.roll = ((WolfEntity)arg).getShakeAnimationProgress(h, -0.2f);
    }
