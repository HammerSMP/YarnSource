...
extends EntityRenderer<FallingBlockEntity> {
    ...
    public void render(FallingBlockEntity arg, float f, float g, MatrixStack arg2, VertexConsumerProvider arg3, int i) {
        ...
        lv4.getModelRenderer().render(lv2, lv4.getModel(lv), lv, lv3, arg2, arg3.getBuffer(RenderLayers.getMovingBlockLayer(lv)), false, new Random(), lv.getRenderingSeed(arg.getFallingBlockPos()), OverlayTexture.DEFAULT_UV);
        arg2.pop();
