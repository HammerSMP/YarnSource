...
public class BuiltinModelItemRenderer {
    ...
    public void render(ItemStack arg, ModelTransformation.Mode arg2, MatrixStack arg3, VertexConsumerProvider arg4, int i, int j) {
        ...
        if (lv == Items.SHIELD) {
            ...
            VertexConsumer lv15 = lv14.getSprite().getTextureSpecificVertexConsumer(ItemRenderer.getDirectGlintVertexConsumer(arg4, this.modelShield.getLayer(lv14.getAtlasId()), true, arg.hasGlint()));
            ...
            arg3.push();
            arg3.scale(1.0f, -1.0f, -1.0f);
            VertexConsumer lv16 = ItemRenderer.getDirectGlintVertexConsumer(arg4, this.modelTrident.getLayer(TridentEntityModel.TEXTURE), false, arg.hasGlint());
