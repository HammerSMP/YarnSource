...
public class TexturedRenderLayers {
    ...
    private static final RenderLayer field_25286 = RenderLayer.method_29379(SpriteAtlasTexture.BLOCK_ATLAS_TEX);
    ...
    public static final SpriteIdentifier[] BED_TEXTURES = (SpriteIdentifier[])Arrays.stream(DyeColor.values()).sorted(Comparator.comparingInt(DyeColor::getId)).map(arg -> new SpriteIdentifier(BEDS_ATLAS_TEXTURE, new Identifier("entity/bed/" + arg.getName()))).toArray(SpriteIdentifier[]::new);
