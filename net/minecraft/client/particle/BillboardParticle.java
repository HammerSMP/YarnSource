...
extends Particle {
    ...
    public void buildGeometry(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        if (this.angle == 0.0f) {
            Quaternion lv2 = camera.getRotation();
        } else {
            lv3 = new Quaternion(camera.getRotation());
        ...
        vertexConsumer.vertex(lvs[0].getX(), lvs[0].getY(), lvs[0].getZ()).texture(n, p).color(this.colorRed, this.colorGreen, this.colorBlue, this.colorAlpha).light(q).next();
        vertexConsumer.vertex(lvs[1].getX(), lvs[1].getY(), lvs[1].getZ()).texture(n, o).color(this.colorRed, this.colorGreen, this.colorBlue, this.colorAlpha).light(q).next();
        vertexConsumer.vertex(lvs[2].getX(), lvs[2].getY(), lvs[2].getZ()).texture(m, o).color(this.colorRed, this.colorGreen, this.colorBlue, this.colorAlpha).light(q).next();
        vertexConsumer.vertex(lvs[3].getX(), lvs[3].getY(), lvs[3].getZ()).texture(m, p).color(this.colorRed, this.colorGreen, this.colorBlue, this.colorAlpha).light(q).next();
    }
