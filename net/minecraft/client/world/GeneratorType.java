...
public abstract class GeneratorType {
    ...
    private static final GeneratorType SINGLE_BIOME_CAVES = new GeneratorType("single_biome_caves"){
        ...
        @Override
        public GeneratorOptions method_29077(DynamicRegistryManager.Impl arg, long l, boolean bl, boolean bl2) {
    ...
    private static GeneratorOptions method_29079(GeneratorOptions arg, GeneratorType arg2, Biome arg3) {
        Supplier<ChunkGeneratorType> supplier3;
        FixedBiomeSource lv = new FixedBiomeSource(arg3);
        if (arg2 == SINGLE_BIOME_CAVES) {
            Supplier<ChunkGeneratorType> supplier = () -> ChunkGeneratorType.field_26359;
        } else if (arg2 == SINGLE_BIOME_FLOATING_ISLANDS) {
            Supplier<ChunkGeneratorType> supplier2 = () -> ChunkGeneratorType.field_26360;
        } else {
            supplier3 = () -> ChunkGeneratorType.field_26355;
        }
        return new GeneratorOptions(arg.getSeed(), arg.shouldGenerateStructures(), arg.hasBonusChest(), GeneratorOptions.method_28608(arg.getDimensionMap(), new SurfaceChunkGenerator(lv, arg.getSeed(), supplier3)));
    }
