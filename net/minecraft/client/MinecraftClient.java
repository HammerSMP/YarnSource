...
WindowEventHandler {
    ...
    public void startIntegratedServer(String string, @Nullable LevelInfo arg2) {
        ...
        try {
            ...
            SystemToast.method_27023(this, string);
            this.openScreen(null);
            return;
        }
        ...
        if (lv3 == null) {
            ...
            String string2 = arg2.method_27339();
    ...
    public class_5195 getMusicType() {
        ...
        if (this.player != null) {
            ...
            if (this.musicTracker.isPlayingType(MusicType.field_5576) || this.player.isSubmergedInWater() && (lv == Biome.Category.OCEAN || lv == Biome.Category.RIVER)) {
