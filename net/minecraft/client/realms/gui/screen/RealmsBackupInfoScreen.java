...
extends RealmsScreen {
    ...
    extends AlwaysSelectedEntryListWidget.Entry<BackupInfoListEntry> {
        ...
        public void render(MatrixStack matrices, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            ...
            RealmsBackupInfoScreen.this.drawStringWithShadow(matrices, lv, this.key, x, y, 0xA0A0A0);
            RealmsBackupInfoScreen.this.drawTextWithShadow(matrices, lv, RealmsBackupInfoScreen.this.checkForSpecificMetadata(this.key, this.value), x, y + 12, 0xFFFFFF);
        }
    }
}
