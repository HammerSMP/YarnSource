...
extends ResourcePackProfile {
    ...
    public ClientResourcePackProfile(String string, boolean bl, Supplier<ResourcePack> supplier, ResourcePack arg, PackResourceMetadata arg2, ResourcePackProfile.InsertionPosition arg3, ResourcePackSource arg4) {
        super(string, bl, supplier, arg, arg2, arg3, arg4);
        this.icon = ClientResourcePackProfile.method_29713(arg);
    }

    public ClientResourcePackProfile(String string, boolean bl, Supplier<ResourcePack> supplier, Text arg, Text arg2, ResourcePackCompatibility arg3, ResourcePackProfile.InsertionPosition arg4, boolean bl2, ResourcePackSource arg5, @Nullable NativeImage arg6) {
