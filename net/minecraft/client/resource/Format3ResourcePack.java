...
implements ResourcePack {
    ...
    public static final Map<Identifier, Identifier> NEW_TO_OLD_MAP = (Map)Util.make(() -> {
        ...
        BiConsumer<String, String> biConsumer = (string, string2) -> {
            Identifier lv = new Identifier((String)string);
            Identifier lv2 = new Identifier((String)string2);
            builder.put((Object)lv, (Object)lv2);
            builder.put((Object)Format3ResourcePack.getMetadataLocation(lv), (Object)Format3ResourcePack.getMetadataLocation(lv2));
        };
