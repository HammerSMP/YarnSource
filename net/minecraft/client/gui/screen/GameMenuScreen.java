...
extends Screen {
    ...
    private void initWidgets() {
        ...
        this.addButton(new ButtonWidget(this.width / 2 - 102, this.height / 4 + 96 + -16, 98, 20, new TranslatableText("menu.options"), arg -> this.client.openScreen(new OptionsScreen(this, this.client.options))));
