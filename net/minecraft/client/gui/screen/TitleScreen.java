...
extends Screen {
    ...
    private void initWidgetsDemo(int y, int spacingY) {
        this.addButton(new ButtonWidget(this.width / 2 - 100, y, 200, 20, new TranslatableText("menu.playdemo"), arg -> this.client.method_29607("Demo_World", MinecraftServer.DEMO_LEVEL_INFO, DynamicRegistryManager.create(), GeneratorOptions.DEMO_CONFIG)));
