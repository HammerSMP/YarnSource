...
extends class_5375 {
    public ResourcePackOptionsScreen(Screen arg, GameOptions arg2, ResourcePackManager<ClientResourcePackProfile> arg3, Runnable runnable) {
        super(arg, new TranslatableText("resourcePack.title"), (Runnable runnable2) -> {
            ...
            return new class_5369<ClientResourcePackProfile>((Runnable)runnable2, ClientResourcePackProfile::drawIcon, Lists.reverse((List)list3), list22, (list, list2, bl) -> {
