...
extends Screen {
    ...
    protected void init() {
        ...
        this.addButton(new ButtonWidget(this.width / 2 - 155, this.height / 6 + 120 - 6, 150, 20, new TranslatableText("options.resourcepack"), arg -> this.client.openScreen(new ResourcePackOptionsScreen((Screen)this, this.settings, this.client.getResourcePackManager(), this.client::reloadResources))));
