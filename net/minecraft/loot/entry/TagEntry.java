...
extends LeafEntry {
    ...
    extends LeafEntry.Serializer<TagEntry> {
        ...
        @Override
        public void toJson(JsonObject jsonObject, TagEntry arg, JsonSerializationContext jsonSerializationContext) {
            super.toJson(jsonObject, arg, jsonSerializationContext);
            jsonObject.addProperty("name", ItemTags.getContainer().checkId(arg.name).toString());
        ...
        protected TagEntry fromJson(JsonObject jsonObject, JsonDeserializationContext jsonDeserializationContext, int i, int j, LootCondition[] args, LootFunction[] args2) {
            ...
            Tag<Item> lv2 = ItemTags.getContainer().get(lv);
            if (lv2 == null) {
