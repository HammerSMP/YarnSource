...
extends ChunkGenerator {
    ...
    private SurfaceChunkGenerator(BiomeSource arg, BiomeSource arg2, long worldSeed, ChunkGeneratorType arg3) {
        super(arg, arg2, arg3.getConfig(), worldSeed);
        ...
        if (lv.hasIslandNoiseOverride()) {
            ChunkRandom lv2 = new ChunkRandom(worldSeed);
            lv2.consume(17292);
        ...
        for (BlockPos lv2 : BlockPos.iterate(i, 0, j, i + 15, 0, j + 15)) {
            if (bl) {
                for (int n = 0; n < 5; ++n) {
                    ...
                    chunk.setBlockState(lv.set(lv2.getX(), l - n, lv2.getZ()), Blocks.BEDROCK.getDefaultState(), false);
                }
            }
            if (!bl2) continue;
            for (int o = 4; o >= 0; --o) {
                if (o > random.nextInt(5)) continue;
                chunk.setBlockState(lv.set(lv2.getX(), k + o, lv2.getZ()), Blocks.BEDROCK.getDefaultState(), false);
            }
        }
    }
