...
implements DecoratorConfig {
    public static final Codec<CountNoiseDecoratorConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)Codec.DOUBLE.fieldOf("noise_level").forGetter(arg -> arg.noiseLevel), (App)Codec.INT.fieldOf("below_noise").forGetter(arg -> arg.belowNoise), (App)Codec.INT.fieldOf("above_noise").forGetter(arg -> arg.aboveNoise)).apply((Applicative)instance, CountNoiseDecoratorConfig::new));
