...
extends TreeDecorator {
    public static final Codec<AlterGroundTreeDecorator> CODEC = BlockStateProvider.CODEC.fieldOf("provider").xmap(AlterGroundTreeDecorator::new, arg -> arg.field_21316).codec();
