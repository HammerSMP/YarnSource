...
implements FeatureConfig {
    public static final Codec<HugeFungusFeatureConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group((App)BlockState.field_24734.fieldOf("valid_base_block").forGetter(arg -> arg.validBaseBlock), (App)BlockState.field_24734.fieldOf("stem_state").forGetter(arg -> arg.stemState), (App)BlockState.field_24734.fieldOf("hat_state").forGetter(arg -> arg.hatState), (App)BlockState.field_24734.fieldOf("decor_state").forGetter(arg -> arg.decorationState), (App)Codec.BOOL.fieldOf("planted").withDefault((Object)false).forGetter(arg -> arg.planted)).apply((Applicative)instance, HugeFungusFeatureConfig::new));
