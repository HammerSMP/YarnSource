...
public abstract class Feature<FC extends FeatureConfig> {
    ...
    public static final BiMap<String, StructureFeature<?>> STRUCTURES = (BiMap)Util.make(HashBiMap.create(), hashBiMap -> {
        hashBiMap.put((Object)"Pillager_Outpost".toLowerCase(Locale.ROOT), PILLAGER_OUTPOST);
        hashBiMap.put((Object)"Mineshaft".toLowerCase(Locale.ROOT), MINESHAFT);
        hashBiMap.put((Object)"Mansion".toLowerCase(Locale.ROOT), WOODLAND_MANSION);
        hashBiMap.put((Object)"Jungle_Pyramid".toLowerCase(Locale.ROOT), JUNGLE_TEMPLE);
        hashBiMap.put((Object)"Desert_Pyramid".toLowerCase(Locale.ROOT), DESERT_PYRAMID);
        hashBiMap.put((Object)"Igloo".toLowerCase(Locale.ROOT), IGLOO);
        hashBiMap.put((Object)"Ruined_Portal".toLowerCase(Locale.ROOT), RUINED_PORTAL);
        hashBiMap.put((Object)"Shipwreck".toLowerCase(Locale.ROOT), SHIPWRECK);
        hashBiMap.put((Object)"Swamp_Hut".toLowerCase(Locale.ROOT), (Object)SWAMP_HUT);
        hashBiMap.put((Object)"Stronghold".toLowerCase(Locale.ROOT), STRONGHOLD);
        hashBiMap.put((Object)"Monument".toLowerCase(Locale.ROOT), OCEAN_MONUMENT);
        hashBiMap.put((Object)"Ocean_Ruin".toLowerCase(Locale.ROOT), OCEAN_RUIN);
        hashBiMap.put((Object)"Fortress".toLowerCase(Locale.ROOT), NETHER_BRIDGE);
        hashBiMap.put((Object)"EndCity".toLowerCase(Locale.ROOT), END_CITY);
        hashBiMap.put((Object)"Buried_Treasure".toLowerCase(Locale.ROOT), BURIED_TREASURE);
        hashBiMap.put((Object)"Village".toLowerCase(Locale.ROOT), VILLAGE);
        hashBiMap.put((Object)"Nether_Fossil".toLowerCase(Locale.ROOT), NETHER_FOSSIL);
        hashBiMap.put((Object)"Bastion_Remnant".toLowerCase(Locale.ROOT), BASTION_REMNANT);
    });
