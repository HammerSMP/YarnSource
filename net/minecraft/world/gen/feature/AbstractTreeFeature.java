...
extends Feature<TreeFeatureConfig> {
    ...
    public static boolean canTreeReplace(TestableWorld arg2, BlockPos arg22) {
        return arg2.testBlockState(arg22, arg -> {
            ...
            return arg.isAir() || arg.isIn(BlockTags.LEAVES) || AbstractTreeFeature.isDirt(lv) || arg.isIn(BlockTags.LOGS) || arg.isIn(BlockTags.SAPLINGS) || arg.isOf(Blocks.VINE) || arg.isOf(Blocks.WATER);
        });
    }
    ...
    private static boolean isDirtOrGrass(TestableWorld arg2, BlockPos arg22) {
        return arg2.testBlockState(arg22, arg -> {
            Block lv = arg.getBlock();
            return AbstractTreeFeature.isDirt(lv) || lv == Blocks.FARMLAND;
        });
    }
    ...
    public static boolean canReplace(ModifiableTestableWorld arg, BlockPos arg2) {
        return AbstractTreeFeature.isAirOrLeaves(arg, arg2) || AbstractTreeFeature.isReplaceablePlant(arg, arg2) || AbstractTreeFeature.isWater(arg, arg2);
    }
    ...
    private boolean generate(ModifiableTestableWorld arg, Random random, BlockPos arg2, Set<BlockPos> set, Set<BlockPos> set2, BlockBox arg32, TreeFeatureConfig arg4) {
        ...
        if (!AbstractTreeFeature.isDirtOrGrass(arg, lv2.down())) {
            return false;
        }
        ...
        for (int s = 0; s <= i + 1; ++s) {
            ...
            block1: for (int u = -t; u <= t; ++u) {
                for (int v = -t; v <= t; ++v) {
                    lv3.set(lv2, u, s, v);
                    if (AbstractTreeFeature.canTreeReplace(arg, lv3) && (arg4.ignoreVines || !AbstractTreeFeature.isVine(arg, lv3))) continue;
    ...
    @Override
    public final boolean generate(IWorld arg, StructureAccessor arg2, ChunkGenerator<? extends ChunkGeneratorConfig> arg32, Random random, BlockPos arg4, TreeFeatureConfig arg5) {
    ...
    private VoxelSet placeLogsAndLeaves(IWorld arg, BlockBox arg2, Set<BlockPos> set, Set<BlockPos> set2) {
        ...
        for (BlockPos lv4 : Lists.newArrayList(set)) {
            ...
            for (Direction lv5 : Direction.values()) {
                ...
                AbstractTreeFeature.setBlockStateWithoutUpdatingNeighbors(arg, lv2, (BlockState)lv6.with(Properties.DISTANCE_1_7, 1));
        ...
        for (int k = 1; k < 6; ++k) {
            ...
            for (BlockPos lv7 : set3) {
                ...
                for (Direction lv8 : Direction.values()) {
                    ...
                    AbstractTreeFeature.setBlockStateWithoutUpdatingNeighbors(arg, lv2, lv10);
