...
public abstract class StructureFeature<C extends FeatureConfig> {
    ...
    private static final Map<Identifier, Identifier> field_25839 = ImmutableMap.builder().put((Object)new Identifier("nvi"), (Object)field_26362).put((Object)new Identifier("pcp"), (Object)field_26362).put((Object)new Identifier("bastionremnant"), (Object)field_26362).put((Object)new Identifier("runtime"), (Object)field_26362).build();
    ...
    public static StructureStart<?> readStructureStart(StructureManager arg, CompoundTag tag, long worldSeed) {
        ...
        try {
            ...
            for (int m = 0; m < lv3.size(); ++m) {
                ...
                if (lv8 == null) {
                    LOGGER.error("Unknown structure piece id: {}", (Object)lv7);
                    continue;
                }
                try {
                    StructurePiece lv9 = lv8.load(arg, lv5);
                    lv4.getChildren().add(lv9);
                    continue;
                }
                catch (Exception exception) {
                    LOGGER.error("Exception loading structure piece with id {}", (Object)lv7, (Object)exception);
                }
            }
            return lv4;
        }
    ...
    public StructureStart<?> tryPlaceStart(DynamicRegistryManager arg, ChunkGenerator arg2, BiomeSource arg3, StructureManager arg4, long worldSeed, ChunkPos arg5, Biome arg6, int referenceCount, ChunkRandom arg7, StructureConfig arg8, C arg9) {
