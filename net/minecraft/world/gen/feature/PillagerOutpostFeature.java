...
extends class_5434 {
    ...
    protected boolean shouldStartAt(ChunkGenerator arg, BiomeSource arg2, long l, ChunkRandom arg3, int i, int j, Biome arg4, ChunkPos arg5, StructurePoolFeatureConfig arg6) {
        ...
        StructureConfig lv = arg.getConfig().getForType(StructureFeature.VILLAGE);
        if (lv == null) {
            return true;
        }
        for (int n = i - 10; n <= i + 10; ++n) {
            for (int o = j - 10; o <= j + 10; ++o) {
                ChunkPos lv2 = StructureFeature.VILLAGE.getStartChunk(lv, l, arg3, n, o);
                if (n != lv2.x || o != lv2.z) continue;
                return false;
            }
        }
        return true;
