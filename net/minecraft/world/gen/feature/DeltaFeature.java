...
extends Feature<DeltaFeatureConfig> {
    ...
    public boolean generate(ServerWorldAccess arg, ChunkGenerator arg2, Random random, BlockPos arg3, DeltaFeatureConfig arg4) {
        ...
        int i = bl2 ? arg4.method_30403().method_30321(random) : 0;
        int j = bl2 ? arg4.method_30403().method_30321(random) : 0;
        boolean bl3 = bl2 && i != 0 && j != 0;
        int k = arg4.method_30402().method_30321(random);
        int l = arg4.method_30402().method_30321(random);
        int m = Math.max(k, l);
