...
public abstract class FoliagePlacer {
    ...
    protected static <P extends FoliagePlacer> Products.P2<RecordCodecBuilder.Mu<P>, UniformIntDistribution, UniformIntDistribution> method_30411(RecordCodecBuilder.Instance<P> instance) {
        return instance.group((App)UniformIntDistribution.createValidatedCodec(0, 8, 8).fieldOf("radius").forGetter(arg -> arg.radius), (App)UniformIntDistribution.createValidatedCodec(0, 8, 8).fieldOf("offset").forGetter(arg -> arg.offset));
    }

    public FoliagePlacer(UniformIntDistribution arg, UniformIntDistribution arg2) {
        this.radius = arg;
        this.offset = arg2;
    }
