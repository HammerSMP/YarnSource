...
public abstract class SurfaceBuilder<C extends SurfaceConfig> {
    ...
    public SurfaceBuilder(Codec<C> codec) {
        this.field_25016 = codec.fieldOf("config").xmap(this::method_30478, ConfiguredSurfaceBuilder::getConfig).codec();
    }
    ...
    public ConfiguredSurfaceBuilder<C> method_30478(C arg) {
        return new ConfiguredSurfaceBuilder<C>(this, arg);
    }
