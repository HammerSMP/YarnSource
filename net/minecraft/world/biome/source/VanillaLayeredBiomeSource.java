...
extends BiomeSource {
    public static final Codec<VanillaLayeredBiomeSource> field_24727 = RecordCodecBuilder.create(instance -> instance.group((App)Codec.LONG.fieldOf("seed").stable().forGetter(arg -> arg.field_24728), (App)Codec.BOOL.optionalFieldOf("legacy_biome_init_layer", (Object)false, Lifecycle.stable()).forGetter(arg -> arg.field_24498), (App)Codec.BOOL.fieldOf("large_biomes").withDefault((Object)false).stable().forGetter(arg -> arg.field_24729)).apply((Applicative)instance, instance.stable((Object)((Function3)VanillaLayeredBiomeSource::new))));
