...
NorthWestCoordinateTransformer {
    ...
    default public int sample(LayerSampleContext<?> arg, LayerSampler arg2, int i, int j) {
        return this.sample(arg, arg2.sample(this.transformX(i + 0), this.transformZ(j + 2)), arg2.sample(this.transformX(i + 2), this.transformZ(j + 2)), arg2.sample(this.transformX(i + 2), this.transformZ(j + 0)), arg2.sample(this.transformX(i + 0), this.transformZ(j + 0)), arg2.sample(this.transformX(i + 1), this.transformZ(j + 1)));
    }
}
