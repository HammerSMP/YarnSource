...
extends Biome {
    public GravellyMountainsBiome() {
        super(new Biome.Settings().configureSurfaceBuilder(class_5471.GRAVELLY_MOUNTAIN).precipitation(Biome.Precipitation.RAIN).category(Biome.Category.EXTREME_HILLS).depth(1.0f).scale(0.5f).temperature(0.2f).downfall(0.3f).effects(new BiomeEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).moodSound(BiomeMoodSound.CAVE).build()).parent("mountains"));
