...
extends Biome {
    public LukewarmOceanBiome() {
        ...
        this.addSpawn(EntityCategory.WATER_AMBIENT, new Biome.SpawnEntry(EntityType.COD, 15, 3, 6));
        this.addSpawn(EntityCategory.WATER_AMBIENT, new Biome.SpawnEntry(EntityType.PUFFERFISH, 5, 1, 3));
