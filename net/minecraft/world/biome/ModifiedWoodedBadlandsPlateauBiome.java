...
extends Biome {
    public ModifiedWoodedBadlandsPlateauBiome() {
        super(new Biome.Settings().configureSurfaceBuilder(class_5471.WOODED_BADLANDS).precipitation(Biome.Precipitation.NONE).category(Biome.Category.MESA).depth(0.45f).scale(0.3f).temperature(2.0f).downfall(0.0f).effects(new BiomeEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).moodSound(BiomeMoodSound.CAVE).build()).parent("wooded_badlands_plateau"));
