...
extends Biome {
    public GiantSpruceTaigaHillsBiome() {
        super(new Biome.Settings().configureSurfaceBuilder(class_5471.GIANT_TREE_TAIGA).precipitation(Biome.Precipitation.RAIN).category(Biome.Category.TAIGA).depth(0.2f).scale(0.2f).temperature(0.25f).downfall(0.8f).effects(new BiomeEffects.Builder().waterColor(4159204).waterFogColor(329011).fogColor(12638463).moodSound(BiomeMoodSound.CAVE).build()).parent("giant_tree_taiga_hills"));
