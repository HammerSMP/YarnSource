...
public class DimensionType {
    ...
    private static final Map<RegistryKey<DimensionType>, DimensionType> field_24759 = ImmutableMap.of(OVERWORLD_REGISTRY_KEY, (Object)DimensionType.method_29563(), THE_NETHER_REGISTRY_KEY, (Object)_NETHER, THE_END_REGISTRY_KEY, (Object)_END);
    ...
    public static DimensionTracker.Modifiable addDefaults(DimensionTracker.Modifiable arg) {
        arg.add(OVERWORLD_REGISTRY_KEY, DimensionType.method_29563());
        arg.add(THE_NETHER_REGISTRY_KEY, _NETHER);
        arg.add(THE_END_REGISTRY_KEY, _END);
        return arg;
    }
    ...
    public static SimpleRegistry<class_5363> method_28517(long l) {
        ...
        lv.add(class_5363.field_25413, new class_5363(() -> _NETHER, DimensionType.method_28535(l)));
        lv.add(class_5363.field_25414, new class_5363(() -> _END, DimensionType.method_28533(l)));
        return lv;
    }
